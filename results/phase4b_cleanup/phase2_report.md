...
- Raw run directories: `results/phase4b_cleanup`
- Per-run CSV: `results/phase4b_cleanup/summary.csv`
- Grouped CSV: `results/phase4b_cleanup/summary_by_config.csv`
- Run timestamp range: 2026-05-28T07:10:43Z to 2026-05-28T07:11:07Z
...
|---|---:|---:|---:|---:|---:|---:|---:|
| hybrid_arbitration_occ | 24 | 1122344.17 | 0.000 | 0.000 | 0.0 | 211.6 | 0.889 |
