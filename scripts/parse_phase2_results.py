...
def write_csv(results_dir, rows):
    fields = [
        ...
        "adaptive_routing_enabled", "routing_margin_us", "cost_window_ms",
        "min_samples_before_adapt", "adaptive_object_scope",
        ...
        "latency_us_p99", "tx_latency_us_p50", "tx_latency_us_p95", "tx_latency_us_p99",
        "tx_latency_us_max", "committed_tx_latency_us_p50", "committed_tx_latency_us_p95",
        "committed_tx_latency_us_p99", "abort_tx_latency_us_p50", "abort_tx_latency_us_p95",
        "abort_tx_latency_us_p99", "cold_occ_latency_us_p50", "cold_occ_latency_us_p95",
        "cold_occ_latency_us_p99", "hot_arbitration_latency_us_p50",
        "hot_arbitration_latency_us_p95", "hot_arbitration_latency_us_p99",
        "retry_count_p50", "retry_count_p95", "retry_count_p99",
        "latency_sample_count", "latency_sampling_mode", "latency_sample_size",
        "hot_object_count", "hot_path_candidate_tx", "hot_path_tx",
        ...
        "service_time_us_max", "hot_cold_interference_count",
        "adaptive_route_to_occ_count", "adaptive_route_to_arbitration_count",
        "adaptive_route_to_occ_ratio", "adaptive_route_to_arbitration_ratio",
        "adaptive_insufficient_samples_count", "adaptive_bad_route_proxy_count",
        "estimated_occ_cost_us_p50", "estimated_occ_cost_us_p95", "estimated_occ_cost_us_p99",
        "estimated_arbitration_cost_us_p50", "estimated_arbitration_cost_us_p95",
        "estimated_arbitration_cost_us_p99", "routing_decision_latency_us_p50",
        "routing_decision_latency_us_p95", "routing_decision_latency_us_p99",
        "oscillation_count", "invariant_violation_count",
...
def write_group_csv(results_dir, groups):
    fields = [
        ...
        "tx_latency_us_p50_mean", "tx_latency_us_p95_mean", "tx_latency_us_p99_mean",
        "committed_tx_latency_us_p50_mean", "committed_tx_latency_us_p95_mean",
        "committed_tx_latency_us_p99_mean", "latency_sample_count_mean",
    ...
    with out.open("w", newline="") as f:
        ...
        for key, rows in sorted(groups.items()):
            ...
            writer.writerow({
                ...
                "tx_latency_us_p50_mean": stats(rows, "tx_latency_us_p50")["mean"],
                "tx_latency_us_p95_mean": stats(rows, "tx_latency_us_p95")["mean"],
                "tx_latency_us_p99_mean": stats(rows, "tx_latency_us_p99")["mean"],
                "committed_tx_latency_us_p50_mean": stats(rows, "committed_tx_latency_us_p50")["mean"],
                "committed_tx_latency_us_p95_mean": stats(rows, "committed_tx_latency_us_p95")["mean"],
                "committed_tx_latency_us_p99_mean": stats(rows, "committed_tx_latency_us_p99")["mean"],
                "latency_sample_count_mean": stats(rows, "latency_sample_count")["mean"],
...
def write_report(rows, groups):
    ...
    lines = [
        ...
        "## Scope",
        "",
        "This report evaluates a RDMA-style DSM prototype in a virtualized Linux + Ubuntu 22.04 + Soft-RoCE/rdma_rxe environment. The results are protocol-level evidence for algorithm behavior only. They are not hardware RDMA NIC latency, throughput, CPU, PCIe, switch, or RNIC offload measurements.",
        "",
